				...
				<div class="content-media">
					...
					<div class="form-field">
						...
						<c:choose>
							...
							<c:otherwise>
								 <button class="submit button-primary full-width-on-mobile" onclick="needWriterId()">Modify</button>
				
							</c:otherwise>
						</c:choose>
		               
		               <button class="submit button-primary full-width-on-mobile" data-oper="list" onclick="location.href='/board/list'">List</button>
